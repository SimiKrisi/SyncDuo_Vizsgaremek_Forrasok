...
{
    internal class SyncDuoApiAdmin
    {
        private readonly HttpClient _client;
        //private readonly string server = "http://localhost:8000";
        ...
        public SyncDuoApiAdmin()
        {
            _client = new HttpClient();
            // Try to read API key from environment variable, fallback to placeholder
            _apiKey = Environment.GetEnvironmentVariable("API_KEY") ?? "admin_api_key_123";
        }
        ...
        private string ValidateUserFields(object fields)
        {
            ...
            if (dict.TryGetValue("display_name", out var nameObj) && nameObj is string displayName)
            {
                if (displayName.Length > 15)
                    return "Error: Too long display name (max 15 character).";
        ...
        /// <summary>
        /// InsertDailyChallenge(json(string))
        /// </summary>
        public async Task<string> InsertDailyChallenge(string dataJson)
        {
            return await SendRequestAsync(HttpMethod.Post, "dailychallenges/insert.php", new { data_json = dataJson });
        }
        ...
        /// <summary>
        /// SelectAllDailyChallenges()
        /// </summary>
        public async Task<string> SelectAllDailyChallenges()
        {
            return await SendRequestAsync(HttpMethod.Get, "dailychallenges/selectAll.php");
        }

        /// <summary>
        /// UpdateDailyChallenge(c_id(int), json(string))
        /// </summary>
        public async Task<string> UpdateDailyChallenge(int DCId, string dataJson)
        {
            return await SendRequestAsync(HttpMethod.Put, "dailychallenges/update.php", new { id = DCId, data_json = dataJson });
        }

        /// <summary>
        /// DeleteDailyChallenge(c_id(int))
        /// </summary>
        public async Task<string> DeleteDailyChallenge(int DCId)
        {
        ...
        /// <summary>
        /// SelectAllAchievementRecords()
        /// </summary>
        public async Task<string> SelectAllAchievementRecords()
        {
            return await SendRequestAsync(HttpMethod.Get, "achievement/selectAll.php");
        }
        ...
        /// <summary>
        /// SelectAllShopRecords()
        /// </summary>
        public async Task<string> SelectAllShopRecords()
        {
            return await SendRequestAsync(HttpMethod.Get, "shop/selectAll.php");
        }
        ...
        /// SelectAllUsers()
        /// </summary>
        public async Task<string> SelectAllUsers()
        {
            return await SendRequestAsync(HttpMethod.Get, "user/selectAll.php");
        }
